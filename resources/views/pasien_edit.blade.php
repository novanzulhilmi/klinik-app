                    ...
                    <div class="card-body">
                        <form action="/pasien/{{ $pasien->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-1 mb-3">
                                ...
                                <img src="{{ $pasien->foto ? asset('storage/images/' . $pasien->foto) : asset('storage/images/nothing.webp') }}" alt="foto pasien" class="img-thumbnail mt-2" style="width:75px" style="aspect-ratio: 1/1">
                            </div>
                            <div class="form-group mt-1 mb-3">
